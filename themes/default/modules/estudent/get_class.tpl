...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			var class_info_url = '{CLASS_INFO_URL}';
			//]]>
		</script>
        ...
        <script type="text/javascript" src="{NV_BASE_SITEURL}modules/{MODULE_FILE}/js/user.js"></script>
	...
	<body>
        ...
        <table class="tab1">
            ...
            <tbody class="{ROW.class}">
                <tr>
                    <td style="width:150px"><a href="javascript:choose_this_class('{ROW.class_id}', class_info_url);" title="{LANG.choose_class}"><strong>{ROW.class_name}</strong></a></td>
