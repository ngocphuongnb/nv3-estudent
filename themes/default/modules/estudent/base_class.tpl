<!-- BEGIN: main -->
<span class="vnp-add"><a class="vnp-button" href="{ADD_LINK}">{LANG.add_base_class}</a></span>
...
<table class="tab1">
    ...
    <tbody class="{ROW.class}">
        <tr>
            ...
            <td>
                <span class="edit_icon"><a href="{ROW.url_edit}">{GLANG.edit}</a></span> &nbsp;&nbsp; <span class="delete_icon"><a href="javascript:void(0);" onclick="nv_module_del({ROW.base_class_id}, 'base_class');">{GLANG.delete}</a></span>&nbsp;&nbsp; <span class="add_icon"><a href="{ROW.url_set_time_table}">{LANG.set_time_table}</a></span>
            </td>
        </tr>
    </tbody>
    <!-- END: row -->
