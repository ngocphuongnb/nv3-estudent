...
$mark = $nv_Request->get_int( 'value', 'post,get', 0 );


$sql = "SELECT `student_id`, `faculty_id`, `year`, `study_result` FROM `" . NV_PREFIXLANG . "_" . $module_data . "_student` WHERE ( `class_ids`='" . $class_id . "' OR `class_ids` REGEXP '^" . $class_id . "\\\,' OR `class_ids` REGEXP '\\\," . $class_id . "\\\,' OR `class_ids` REGEXP '\\\," . $class_id . "\$')";
